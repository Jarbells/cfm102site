...
public class RadioInfoDTO {
    ...
    public String getSocialInstagramUrl() { return socialInstagramUrl; }
    public void setSocialInstagramUrl(String socialInstagramUrl) { this.socialInstagramUrl = socialInstagramUrl; }
    public String getSocialFacebookUrl() { return socialFacebookUrl; }
    public void setSocialFacebookUrl(String socialFacebookUrl) { this.socialFacebookUrl = socialFacebookUrl; }
    public String getSocialYoutubeUrl() { return socialYoutubeUrl; }
    public void setSocialYoutubeUrl(String socialYoutubeUrl) { this.socialYoutubeUrl = socialYoutubeUrl; }
    public String getSocialXUrl() { return socialXUrl; }
    public void setSocialXUrl(String socialXUrl) { this.socialXUrl = socialXUrl; }
}